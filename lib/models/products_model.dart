...
class ProductData {
  ...
  ProductData.fromJson(dynamic json) {
    ...
    _plant = json['plant'] != null ? ProductPlant.fromJson(json['plant']) : null;
  ...
  ProductPlant? _plant;
  ProductTool? _tool;
ProductData copyWith({  String? productId,
  String? name,
  String? description,
  String? imageUrl,
  String? type,
  ...
  ProductPlant? plant,
  ProductTool? tool,
}) => ProductData(  productId: productId ?? _productId,
  name: name ?? _name,
...
class ProductTool {
  ...
  String? _description;
  String? _imageUrl;
ProductTool copyWith({  String? toolId,
  String? name,
  String? description,
  String? imageUrl,
}) => ProductTool(  toolId: toolId ?? _toolId,
  name: name ?? _name,
  description: description ?? _description,
  imageUrl: imageUrl ?? _imageUrl,
);
...
ProductPlant plantFromJson(String str) => ProductPlant.fromJson(json.decode(str));
...
class ProductPlant {
  ...
  int? _sunLight;
  int? _temperature;
ProductPlant copyWith({  String? plantId,
  String? name,
  String? description,
  String? imageUrl,
  int? waterCapacity,
  int? sunLight,
  int? temperature,
}) => ProductPlant(  plantId: plantId ?? _plantId,
  name: name ?? _name,
  description: description ?? _description,
  imageUrl: imageUrl ?? _imageUrl,
...
class ProductSeed {
  ...
  String? _description;
  String? _imageUrl;
ProductSeed copyWith({  String? seedId,
  String? name,
  String? description,
  String? imageUrl,
}) => ProductSeed(  seedId: seedId ?? _seedId,
  name: name ?? _name,
  description: description ?? _description,
  imageUrl: imageUrl ?? _imageUrl,
);
