...
AddToCartModel copyWith({  List<DataCard>? dataCard,
}) => AddToCartModel(  dataCard: dataCard ?? _dataCard,
);
...
class DataCard {
  ...
  int? _cartCount;
  int? _price;
DataCard copyWith({  String? productId,
  String? name,
  String? imageUrl,
  int? cartCount,
  int? price,
}) => DataCard(  productId: productId ?? _productId,
  name: name ?? _name,
