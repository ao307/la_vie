...
//
  ...
  static const cSecondColor = Color(0xff99C4C8);
  static const cThirdColor = Color(0xff99C4C8);
  static const cFourthColor = Color(0xffE5CB9F);
  static const cFifthColor = Color(0xffEEE4AB);


  static const cErrorColor = Color(0xffBC2729);
  static const cGoogleColor = Color(0xFFBB001B);
  static const cFacebookColor = Color(0xFF4267B2);
  ...
  static const cTextButtonLight = Colors.white;
  static const cTextButtonDark = Colors.white;

  static const cTextSubtitleLight = Colors.grey;
  static const cTextSubtitleDark = Colors.white;

  static const cSelectedIcon = Color(0xff1ABC00);
